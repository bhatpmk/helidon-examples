...
/**
 * HTTP representation of one materialized page of Pokémon rows.
 *
 * @param page       zero-based page number
 * @param size       requested page size
 * @param totalSize  total number of rows
 * @param totalPages total number of pages
 * @param items      rows in this page
 */
@Json.Entity
public record PokemonPageDto(int page,
    ...
    static PokemonPageDto create(int page, int size, List<PokemonRow> rows, int totalSize) {
