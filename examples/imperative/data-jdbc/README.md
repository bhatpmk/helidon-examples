Helidon Data SE Imperative JDBC Example
----

This example demonstrates the Helidon Data JDBC imperative API in a Helidon SE application.
It uses the same pokemon schema and HTTP shape as the declarative JDBC example, but it does
not use repository interfaces, annotation processing, declarative endpoints, or generated
...
```shell
java -jar target/helidon-examples-imperative-data-jdbc.jar
```
